...
use Den1ske\SendPulseAPI\SendPulseInterface;
...
class SendPulse implements SendPulseInterface
{
     ...
     * @return mixed|stdClass
     */
    public function addEmails($bookId, $emails, $params)
    {
     ...
     * @return mixed|stdClass
     */
    public function createPushTask($taskInfo, $additionalParams = [])
    {
        $data = $taskInfo;
        if (!isset($data['ttl'])) {
            $data['ttl'] = 0;
